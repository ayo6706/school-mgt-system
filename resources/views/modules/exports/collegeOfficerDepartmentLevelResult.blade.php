<table>
    ...
    <tr>
        <th colspan="14">Session: {{$resultInfo['sessionYearInitial']}}/{{$resultInfo['sessionYearFinal']}}</th>
    </tr>
    <tr>
        <th colspan="14">Semester: {{$resultInfo['semesterName']}}</th>
    </tr>
    <tr>
        <th colspan="14">Department: {{$resultInfo['departmentName']}}</th>
    </tr>
    <tr>
        <th colspan="14">Level: {{$resultInfo['level']}}</th>
    </tr>
    <tr>
        {{--<th> </th>--}}
        {{--<th> </th>--}}
