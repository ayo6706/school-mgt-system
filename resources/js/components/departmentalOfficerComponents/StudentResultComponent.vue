    ...
    export default {
        ...
        methods: {
            ...
            getDepartmentLevelResult() {
                ...
                if(this.checkForm()) {
                    axios.post('departmental-officer/download-departmental-student-result-pdf',{
                        level: this.level,
                        ...
                        link.href = url;
                        link.setAttribute('download', 'department-student-result.zip'); //or any other extension
